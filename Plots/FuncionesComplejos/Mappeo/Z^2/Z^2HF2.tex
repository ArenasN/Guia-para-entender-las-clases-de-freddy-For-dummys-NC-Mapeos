\begin{tikzpicture}
        ...
        \draw[rotate=-90,line width=2pt]   plot[smooth,domain=-2.55:2.55] (\x, {((\x)^2/1.3)-2}) (0,-2) node[above left]{$\kappa_2'$} plot[smooth,domain=-1.4142:1.4142] (\x, {((\x)^2*2)-1}) (0,-1) node[right]{$\kappa_1'$};
\end{tikzpicture}
